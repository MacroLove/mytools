...
from PyQt5.QtGui import QCursor, QBrush, QScreen, QKeySequence
...
if __name__ == '__main__':
    class testwin(QWidget):  # 随便设置的一个ui,
        def __init__(self):
            ...
            self.resize(300, 200)
            # self.shortcut_open = QShortcut(QKeySequence('Alt+Z'), self)
            # self.shortcut_open.activated.connect(self.ss)
        ...
        def showMinimized(self) -> None:
            super(testwin, self).showMinimized()
            self.ss()
